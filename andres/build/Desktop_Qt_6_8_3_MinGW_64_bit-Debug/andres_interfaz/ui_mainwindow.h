...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        label->setPixmap(QPixmap(QString::fromUtf8(":/imagenes trabajo/imagenes trabajo/herramienta-de-filtro-forma-negra.png")));
        ...
        label_2->setPixmap(QPixmap(QString::fromUtf8(":/imagenes trabajo/imagenes trabajo/usuario.png")));
        label_2->setScaledContents(true);
        lineEdit_2 = new QLineEdit(centralwidget);
        lineEdit_2->setObjectName("lineEdit_2");
        lineEdit_2->setGeometry(QRect(360, 30, 121, 31));
        lineEdit_2->setLayoutDirection(Qt::LayoutDirection::LeftToRight);
        lineEdit_2->setAlignment(Qt::AlignmentFlag::AlignCenter);
        label_3 = new QLabel(centralwidget);
        label_3->setObjectName("label_3");
        label_3->setGeometry(QRect(40, 100, 31, 31));
        label_3->setPixmap(QPixmap(QString::fromUtf8(":/imagenes trabajo/imagenes trabajo/busqueda-de-lupa.png")));
