...
public:
    ...
    QScrollBar *scroll_filtro;
    QScrollBar *scroll_apps;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        scroll_filtro = new QScrollBar(centralwidget);
        scroll_filtro->setObjectName("scroll_filtro");
        scroll_filtro->setGeometry(QRect(750, 160, 20, 251));
        scroll_filtro->setOrientation(Qt::Orientation::Vertical);
        scroll_apps = new QScrollBar(centralwidget);
        scroll_apps->setObjectName("scroll_apps");
        scroll_apps->setGeometry(QRect(490, 160, 20, 251));
        scroll_apps->setOrientation(Qt::Orientation::Vertical);
        ...
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/imagenestrabajo/imagenes trabajo/me-gusta.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/imagenestrabajo/imagenes trabajo/descargas.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        ...
        QIcon icon2;
        icon2.addFile(QString::fromUtf8(":/imagenestrabajo/imagenes trabajo/no.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        no_descargados->setIcon(icon2);
        no_descargados->setIconSize(QSize(20, 20));
        label = new QLabel(centralwidget);
        label->setObjectName("label");
        label->setGeometry(QRect(560, 100, 31, 31));
        label->setPixmap(QPixmap(QString::fromUtf8(":/imagenestrabajo/imagenes trabajo/filtrar.png")));
